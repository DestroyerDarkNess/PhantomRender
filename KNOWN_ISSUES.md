...
### 3. Compatibility is validated per tested title, not universally guaranteed
...
- DX9, DX10, DX11, DX12, and OpenGL are implemented and working in current validation.
