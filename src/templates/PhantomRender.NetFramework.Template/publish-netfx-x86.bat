...
set "SCRIPT_DIR=%~dp0"
set "PROJECT=%SCRIPT_DIR%$safeprojectname$.csproj"
set "PRESET=%SCRIPT_DIR%$safeprojectname$.json"
set "TARGET=%SCRIPT_DIR%bin\x86\Release\net48\$safeprojectname$.dll"
...
dotnet build "%PROJECT%" -c Release -p:OutputType=Library -p:Platform=x86
